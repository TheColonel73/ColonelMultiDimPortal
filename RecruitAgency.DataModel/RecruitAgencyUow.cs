...
{
    /// <summary>
    /// The Recruit Agency "Unit of Work"
    ...
    /// </remarks>
    public class RecruitAgencyUow : IRecruitAgencyUow, IDisposable
    {
        public RecruitAgencyUow(IRepositoryProvider repositoryProvider)
        {
            CreateDbContext();
        ...
        {
            DbContext = new RecruitAgencyDbContext();
        ...
        private RecruitAgencyDbContext DbContext { get; set; }
